...
- Cloud AI removal is limited to V3-001. Agent/CLI analyze and approval paths remain for V3-002 through V3-004; the future CLI-side user-owned AI bridge remains unimplemented.
