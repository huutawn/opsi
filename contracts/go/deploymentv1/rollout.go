...
const (
	...
	RolloutCodeRegistryCredentialUnavailable = "REGISTRY_CREDENTIAL_UNAVAILABLE"
	RolloutCodeRegistryAuthFailed            = "REGISTRY_AUTH_FAILED"
	RolloutCodeImagePullFailed               = "IMAGE_PULL_FAILED"
	RolloutCodeImageDigestNotFound           = "IMAGE_DIGEST_NOT_FOUND"
