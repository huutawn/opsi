...
export function ProjectPicker({
  ...
  return (
    <details className="projectSwitcher" ref={menu}>
      <summary aria-label="Switch project">
        <span className="switcherContext">Workspace</span>
      ...
      <div className="switcherMenu">
        ...
        {projects.map((item) => (
          <a
            ...
            href={routeHref({ projectID: item.id, view: "overview" })}
            key={item.id}
        ...
        <a href={routeHref({ view: "projects" })} onClick={(event) => choose(event)}>
          Browse all projects
        </a>
      </div>
    </details>
