...
const component = new URL("../../../../features/security/security-view.tsx", import.meta.url);
const accessTab = new URL("../../../../features/security/access-tab.tsx", import.meta.url);
const overviewTab = new URL("../../../../features/security/overview-tab.tsx", import.meta.url);
const auditTab = new URL("../../../../features/security/audit-tab.tsx", import.meta.url);
const router = new URL("../../../../features/console/router-map.tsx", import.meta.url);
