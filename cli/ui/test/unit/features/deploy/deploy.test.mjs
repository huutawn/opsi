...
const view = new URL("../../../../features/deploy/deploy-view.tsx", import.meta.url);
const review = new URL("../../../../features/deploy/plan-review.tsx", import.meta.url);
const secretEditor = new URL("../../../../features/deploy/secret-configuration-editor.tsx", import.meta.url);
const sourceStep = new URL("../../../../features/deploy/source-step.tsx", import.meta.url);
const hostnameQuota = new URL("../../../../features/deploy/public-hostname-quota.tsx", import.meta.url);
...
test("Resource allocation proposal dialog and recommendation API integration", async () => {
  const proposalDialog = new URL("../../../../features/deploy/resource-proposal-dialog.tsx", import.meta.url);
