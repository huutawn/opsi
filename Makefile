...
verify-postgres:
	...
	cd cloud; OPSI_TEST_DATABASE_URL="$$dsn" OPSI_REQUIRE_POSTGRES_TESTS=1 GOCACHE=$(GOCACHE) GOTOOLCHAIN=$(GOTOOLCHAIN) go test -tags postgresintegration -p 1 ./internal/postgres ./internal/auth ./internal/actiondevice ./internal/buildjob ./internal/registry ./internal/resource ./internal/backup ./internal/restore ./internal/cutover ./internal/adminbootstrap ./internal/deploymentworkflow ./internal/webhookrelay -run 'Test(Postgres|R5012)' -count=1
